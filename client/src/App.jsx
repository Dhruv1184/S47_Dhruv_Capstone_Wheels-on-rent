...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/rentForm' element={<InsertForm formTitle="Add vehicle for Sell" formUrl="rent/insert" cost="Price/hr"/>}></Route>
      <Route path='/saleForm' element={<InsertForm formTitle="Add vehicle for Rent" formUrl="sale/insert" cost="Price"/>}></Route>
    </Routes>
